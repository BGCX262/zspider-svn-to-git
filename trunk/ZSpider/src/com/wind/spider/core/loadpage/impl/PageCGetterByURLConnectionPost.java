...
/**
 * 通过URLConnetion,Post请求获取页面内容<br>
 * 
 * @author yanjun.zhou
 * @version 1.1, 2012-10-26
 * 
 */
public class PageCGetterByURLConnectionPost implements PageCodeGetter
{
	/**
	 * Post请求获取页面内容
	 */
	public String doGainPageCode(VisitURL visitURL)
	{
		...
		try
		{
			URL realUrl = new URL(visitURL.getUrl());
			// 打开和URL之间的连接
